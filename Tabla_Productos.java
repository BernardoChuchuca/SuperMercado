...
public class Tabla_Productos extends AbstractTableModel {
    public String[] columnas = {"Id","Codigo","Nombre","Fecha Ela","Fecha Cad","Compañia","Precio","Stock","Iva","Descuento","Categoria","Proveedor","Nacionalidad"};//array de las columnas con el titulo del contenido
